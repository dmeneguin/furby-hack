...
#define TFT1_CS 4         // TFT 1 chip select pin (set to -1 to use TFT_eSPI setup)
#define TFT2_CS 5        // TFT 2 chip select pin (set to -1 to use TFT_eSPI setup)
...
#define TFT_DC   0
#define TFT_BL   5
#define TFT_RST 2 // as it was undefined for Seeed as well
